"""Single entry point for legacy Azure and target AWS runtime modes."""
...
def main():
    ...
    # The target runtime intentionally avoids Azure imports and scheduler threads.
    if "--aws" in sys.argv:
        from api.aws_app import app
        uvicorn.run(app, host="0.0.0.0", port=8000)
        return

    # Legacy Azure compatibility mode; removed after the production cutover.
